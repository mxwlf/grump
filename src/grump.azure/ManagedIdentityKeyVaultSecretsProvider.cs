...
namespace Grump.Azure
{
    public class ManagedIdentityKeyVaultSecretsProvider : ISecretsProvider
    {
        ...
        public ManagedIdentityKeyVaultSecretsProvider(IConfiguration configuration)
        {
        ...
        /// </remarks>
        internal ManagedIdentityKeyVaultSecretsProvider(IConfiguration configuration, IKeyVaultClient keyVaultClient): this(configuration)
        {
